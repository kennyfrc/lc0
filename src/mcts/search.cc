...
namespace lczero {
    ...
    const char *Search::kRandomRootStr = "Every 10th root node selected randomly";
...
// Maximum delay between outputting "uci info" when nothing interesting happens.
    ...
    void Search::PopulateUciParams(OptionsParser *options) {
        ...
        options->Add<BoolOption>(kRandomRootStr, "random-root") = false;
    ...
    Search::Search(const NodeTree &tree, Network *network,
            ...
            : root_node_(tree.GetCurrentHead()),
              ...
              kRandomRoot(options.Get<bool>(kRandomRootStr)),
